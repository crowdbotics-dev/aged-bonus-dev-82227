"""
Django settings for aged_bonus_dev_82227 project.
...
ROOT_URLCONF = 'aged_bonus_dev_82227.urls'
...
WSGI_APPLICATION = 'aged_bonus_dev_82227.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_bonus_dev_82227 API",
    "DESCRIPTION": "API documentation for aged_bonus_dev_82227 App",
    "VERSION": "v1",
}
